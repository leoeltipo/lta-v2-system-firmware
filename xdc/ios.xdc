...
set_property PACKAGE_PIN E21 [get_ports V_5V5P_SYNC]
set_property IOSTANDARD LVCMOS33 [get_ports V_5V5P_SYNC]
#set_property PACKAGE_PIN L15 [get_ports 15VN_EN]
#set_property IOSTANDARD LVCMOS33 [get_ports 15VN_EN]
set_property PACKAGE_PIN D22 [get_ports V_15VN_SYNC]
set_property IOSTANDARD LVCMOS33 [get_ports V_15VN_SYNC]
#set_property PACKAGE_PIN L14 [get_ports 15VP_EN]
#set_property IOSTANDARD LVCMOS33 [get_ports 15VP_EN]
set_property PACKAGE_PIN E22 [get_ports V_15VP_SYNC]
set_property IOSTANDARD LVCMOS33 [get_ports V_15VP_SYNC]
#set_property PACKAGE_PIN K17 [get_ports 30VN_EN]
#set_property IOSTANDARD LVCMOS33 [get_ports 30VN_EN]
set_property PACKAGE_PIN D20 [get_ports V_30VN_SYNC]
set_property IOSTANDARD LVCMOS33 [get_ports V_30VN_SYNC]
set_property PACKAGE_PIN C20 [get_ports V_100VP_SYNC]
set_property IOSTANDARD LVCMOS33 [get_ports V_100VP_SYNC]
...
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_A_CLK_N]
#set_property PACKAGE_PIN AA5 [get_ports ADC_A_CLK_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_A_CLK_P]
#set_property PACKAGE_PIN AB1 [get_ports ADC_A_CNVRT_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_A_CNVRT_N]
#set_property PACKAGE_PIN AA1 [get_ports ADC_A_CNVRT_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_A_CNVRT_P]
#set_property PACKAGE_PIN AB2 [get_ports ADC_A_DATA0_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_A_DATA0_N]
#set_property PACKAGE_PIN AB3 [get_ports ADC_A_DATA0_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_A_DATA0_P]
#set_property PACKAGE_PIN AA3 [get_ports ADC_A_DATA1_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_A_DATA1_N]
#set_property PACKAGE_PIN Y3 [get_ports ADC_A_DATA1_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_A_DATA1_P]
...
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_B_CLK_N]
#set_property PACKAGE_PIN J5 [get_ports ADC_B_CLK_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_B_CLK_P]
#set_property PACKAGE_PIN J1 [get_ports ADC_B_CNVRT_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_B_CNVRT_N]
#set_property PACKAGE_PIN K1 [get_ports ADC_B_CNVRT_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_B_CNVRT_P]
#set_property PACKAGE_PIN J2 [get_ports ADC_B_DATA0_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_B_DATA0_N]
#set_property PACKAGE_PIN K2 [get_ports ADC_B_DATA0_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_B_DATA0_P]
#set_property PACKAGE_PIN G2 [get_ports ADC_B_DATA1_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_B_DATA1_N]
#set_property PACKAGE_PIN H2 [get_ports ADC_B_DATA1_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_B_DATA1_P]
...
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_C_CLK_N]
#set_property PACKAGE_PIN M1 [get_ports ADC_C_CLK_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_C_CLK_P]
#set_property PACKAGE_PIN L4 [get_ports ADC_C_CNVRT_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_C_CNVRT_N]
#set_property PACKAGE_PIN L5 [get_ports ADC_C_CNVRT_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_C_CNVRT_P]
#set_property PACKAGE_PIN M2 [get_ports ADC_C_DATA0_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_C_DATA0_N]
#set_property PACKAGE_PIN M3 [get_ports ADC_C_DATA0_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_C_DATA0_P]
#set_property PACKAGE_PIN J6 [get_ports ADC_C_DATA1_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_C_DATA1_N]
#set_property PACKAGE_PIN K6 [get_ports ADC_C_DATA1_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_C_DATA1_P]
...
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_D_CLK_N]
#set_property PACKAGE_PIN W6 [get_ports ADC_D_CLK_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_D_CLK_P]
#set_property PACKAGE_PIN AA6 [get_ports ADC_D_CNVRT_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_D_CNVRT_N]
#set_property PACKAGE_PIN Y6 [get_ports ADC_D_CNVRT_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_D_CNVRT_P]
#set_property PACKAGE_PIN V5 [get_ports ADC_D_DATA0_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_D_DATA0_N]
#set_property PACKAGE_PIN U6 [get_ports ADC_D_DATA0_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_D_DATA0_P]
#set_property PACKAGE_PIN T6 [get_ports ADC_D_DATA1_N]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_D_DATA1_N]
#set_property PACKAGE_PIN R6 [get_ports ADC_D_DATA1_P]
#set_property IOSTANDARD LVCMOS25 [get_ports ADC_D_DATA1_P]
...
set_property PACKAGE_PIN V8 [get_ports DAC_SYNCn]
set_property IOSTANDARD LVCMOS25 [get_ports DAC_SYNCn]
...
set_property PACKAGE_PIN T16 [get_ports TEL_CSn]
set_property IOSTANDARD LVCMOS33 [get_ports TEL_CSn]
